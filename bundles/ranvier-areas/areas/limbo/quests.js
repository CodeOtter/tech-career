...
module.exports = (srcPath) => {
 ...
 - Equip it using '<white>wield sword</white>' and '<white>wear vest</white>'`,
      ...
      goals: [
        ...
        {
          type: EquipGoal,
          config: { title: 'Wield A Ticket', slot: 'wield' }
        },
        {
          type: EquipGoal,
...
Once you find some bring it back to the rat, use '<white>quest log</white>' to find the quest number, then complete the quest with '<white>quest complete #</white>'`,
    ...
    3: {
      config: {
        ...
        requires: [ "limbo:1" ],
        autoComplete: true,
        desc: `A voice whispers to you: It would be wise to practice protecting yourself. There are a number of frightened interns in this area that, while not pushovers, will not be too difficult.

- Use '<white>attack intern</white>' to start combat against the intern
